 ...
 */
@Route
@PWA(name = "High Mobility Application",
        shortName = "HiMo")
...
public class MainView extends VerticalLayout {
    ...
    public MainView(@Autowired GreetService service) {
		...
		button.addClickListener(evt -> saveAndNavigate("Eva", start.getValue(), dest.getValue(), datePicker.getValue(), timePicker.getValue()));
	...
	private void saveAndNavigate(String userName, String start, String destination, LocalDate date, LocalTime time)
	{
		Notification.show("klappt!");
//		VaadinSession.getCurrent().setAttribute(TravelData.class.getName(), new TravelData(isFahrer, UserFactory.getUserByUserName(userName), start, destination,
//				date, time));
